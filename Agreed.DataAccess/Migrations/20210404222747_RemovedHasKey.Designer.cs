...
namespace Agreed.DataAccess.Migrations
{
    ...
    [Migration("20210404222747_RemovedHasKey")]
            ...
            modelBuilder.Entity("Agreed.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoDeliveryDate = new DateTime(2021, 4, 5, 1, 27, 45, 535, DateTimeKind.Local).AddTicks(2610),
                            CommissionRate = 10.5,
                            DeliveryAddress = "Denizli",
                            DiscountAmount = 10m,
                            Email = "anil@hacyazilim.com.tr",
                            OrderDate = new DateTime(2021, 3, 29, 1, 27, 45, 541, DateTimeKind.Local).AddTicks(3454),
                            OrderNumber = "123",
                            OrderStatus = "",
                            PackageNumber = "123",
                            Piece = 1,
