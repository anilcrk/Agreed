...
namespace Agreed.DataAccess.Migrations
{
    ...
    [Migration("20210501173805_updtedSellerID")]
    partial class updtedSellerID
    {
            ...
            modelBuilder.Entity("Agreed.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoDeliveryDate = new DateTime(2021, 5, 1, 20, 38, 4, 239, DateTimeKind.Local).AddTicks(9405),
                            CommissionRate = 10.5,
                            DeliveryAddress = "Denizli",
                            DiscountAmount = 10m,
                            Email = "anil@hacyazilim.com.tr",
                            OrderDate = new DateTime(2021, 4, 24, 20, 38, 4, 242, DateTimeKind.Local).AddTicks(7583),
                            OrderNumber = "123",
                            OrderStatus = "",
                            PackageNumber = "123",
                            Piece = 1,
