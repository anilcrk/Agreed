...
namespace Agreed.DataAccess.Migrations
{
    ...
    [Migration("20210320210022_Initial")]
            ...
            modelBuilder.Entity("Agreed.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoDeliveryDate = new DateTime(2021, 3, 21, 0, 0, 21, 585, DateTimeKind.Local).AddTicks(4192),
                            CommissionRate = 10.5,
                            DeliveryAddress = "Denizli",
                            DiscountAmount = 10m,
                            Email = "anil@hacyazilim.com.tr",
                            OrderDate = new DateTime(2021, 3, 14, 0, 0, 21, 587, DateTimeKind.Local).AddTicks(4994),
                            OrderStatus = 0,
                            PackageNumber = "123",
                            Piece = 1,
                            ProductName = "HAC",
