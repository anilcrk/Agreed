...
namespace Agreed.DataAccess.Migrations
{
    ...
    [Migration("20210502004400_companyIdaded")]
    partial class companyIdaded
    {
            ...
            modelBuilder.Entity("Agreed.Core.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoDeliveryDate = new DateTime(2021, 5, 2, 3, 43, 59, 64, DateTimeKind.Local).AddTicks(3624),
                            CommissionRate = 10.5,
                            CompanyId = 0,
                            DeliveryAddress = "Denizli",
                            DiscountAmount = 10m,
                            Email = "anil@hacyazilim.com.tr",
                            OrderDate = new DateTime(2021, 4, 25, 3, 43, 59, 66, DateTimeKind.Local).AddTicks(8382),
                            OrderNumber = "123",
                            OrderStatus = "",
                            PackageNumber = "123",
                            Piece = 1,
